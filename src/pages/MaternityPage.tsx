...
export const MaternityPage: React.FC<MaternityPageProps> = ({ onNavigate }) => {
  const page = PAGES_DATA.maternity;
  ...
  return (
    <div className="w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="pt-2 flex items-center gap-2 text-xs text-[#9CAA8C] uppercase tracking-wider">
              <span>Ideal Window: 28 to 34 Weeks</span>
              <span>&middot;</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6 text-left">
            <div className="bg-[#FAF5EF] p-5 rounded-[16px] border border-[#EAD3CE]">
              ...
              <p className="text-xs text-[#362E2B]/75 leading-relaxed">
                Relaxed pacing with breaks for resting whenever you need.
              </p>
            </div>
            ...
            <div className="bg-[#FAF5EF] p-5 rounded-[16px] border border-[#EAD3CE]">
              ...
              <p className="text-xs text-[#362E2B]/75 leading-relaxed">
                Clear recommendations on fabrics and colors beforehand.
              </p>
            </div>
            ...
            <div className="bg-[#FAF5EF] p-5 rounded-[16px] border border-[#EAD3CE]">
              ...
              <p className="text-xs text-[#362E2B]/75 leading-relaxed">
                Welcome to join for part of the session at no extra charge.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          <div className="bg-[#FAF5EF] border border-[#EAD3CE] rounded-[20px] p-8 shadow-xs flex flex-col justify-between">
            <p className="font-display text-xl text-[#362E2B]/90 italic leading-relaxed mb-6">
              &ldquo;It was wonderful experience... I really enjoyed my maternity shoot.&rdquo;
            </p>
          ...
          <div className="bg-[#FAF5EF] border border-[#EAD3CE] rounded-[20px] p-8 shadow-xs flex flex-col justify-between">
            <p className="font-display text-xl text-[#362E2B]/90 italic leading-relaxed mb-6">
              &ldquo;We really enjoyed my wife&apos;s maternity shoot... we highly recommend your photography to everyone.&rdquo;
            </p>
            <div className="pt-4 border-t border-[#EAD3CE]/40">
              <span className="caption-text text-[#6E4E53] font-semibold block">
                Arsh M.
      ...
      <section className="py-16 max-w-4xl mx-auto px-6 lg:px-12">
        <FaqAccordion items={page.faq_block} title="Maternity Session Questions" headingTag="h2" />
      </section>
      ...
      <section id="booking-section" className="py-20 max-w-3xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-10 space-y-2">
          ...
          <p className="text-sm text-[#362E2B]/75">
            Ideal between 28 and 34 weeks. Falguni will get back to you with available dates.
          </p>
        </div>
        <BookingForm defaultSessionType="Maternity Photography" />
      </section>
    </div>
  );
};
