...
export const CakeSmashPage: React.FC<CakeSmashPageProps> = ({ onNavigate }) => {
  const page = PAGES_DATA.cakeSmash;
  const hero = page.sections[0];
  const included = page.sections[1];
  const testimonial = page.sections[2];
  ...
  return (
    <div className="w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="pt-2 flex items-center gap-2 text-xs text-[#9CAA8C] uppercase tracking-wider">
              <span>First Birthday Milestone</span>
              <span>&middot;</span>
              <span>Studio Cleanup Included</span>
              <span>&middot;</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6 text-left">
            <div className="bg-[#FAF5EF] p-5 rounded-[16px] border border-[#EAD3CE]">
              ...
              <p className="text-xs text-[#362E2B]/75 leading-relaxed">
                Timed around your baby&apos;s best awake window between naps.
              </p>
            </div>
            ...
            <div className="bg-[#FAF5EF] p-5 rounded-[16px] border border-[#EAD3CE]">
              ...
              <p className="text-xs text-[#362E2B]/75 leading-relaxed">
                Full boutique studio setup ready to go when you arrive.
              </p>
            </div>
            ...
            <div className="bg-[#FAF5EF] p-5 rounded-[16px] border border-[#EAD3CE]">
              ...
              <p className="text-xs text-[#362E2B]/75 leading-relaxed">
                Quick splash bath and full studio cleanup so you leave clean.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 3. TESTIMONIAL: H2 */}
      <section className="py-20 max-w-3xl mx-auto px-6 lg:px-12 text-center">
        <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl text-[#362E2B] mb-12 font-normal">
          {testimonial.headline}
        </h2>

        <div className="bg-[#FAF5EF] border border-[#EAD3CE] rounded-[20px] p-8 md:p-10 shadow-xs text-left">
          <p className="font-display text-2xl text-[#362E2B]/90 italic leading-relaxed mb-6">
            &ldquo;Excellent service, I did my little one&apos;s first birthday photographs through her, she did amazing work.&rdquo;
          </p>
      ...
      <section className="py-16 max-w-4xl mx-auto px-6 lg:px-12">
        <FaqAccordion items={page.faq_block} title="Cake Smash Questions" headingTag="h2" />
      </section>
      ...
      <section id="booking-section" className="py-20 max-w-3xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-10 space-y-2">
          <h2 className="font-display text-3xl sm:text-4xl text-[#362E2B] font-normal">
            Book a First Birthday Cake Smash
          </h2>
          <p className="text-sm text-[#362E2B]/75">
            Tell us your baby&apos;s birthday timeframe. Falguni will follow up with available studio slots.
          </p>
        </div>
        <BookingForm defaultSessionType="Cake Smash Photography" />
      </section>
    </div>
  );
};
